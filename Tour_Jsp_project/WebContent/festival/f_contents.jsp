...
<title>fes_contents</title>
	...
	<style type="text/css">
		...
		.f_con_title{ text-align: center; }
		.f_con_title h2{ margin-bottom: 20px;}
		.f_con_title h5{ margin-bottom: 50px;}
		
		.f_con_tab ul{ padding:20px 0px; border-bottom: solid 1px silver; border-top: solid 1px silver; text-align: center;}
		.f_con_tab li{  display: inline; font-size: 20px; padding:0px 100px; }
		
		.f_con_subtitle{ border-bottom: solid 2px black;  padding: 1px 0px 0px 5px; margin-top: 50px; margin-bottom: 40px;  }
		#f_con_info p{ margin:20px 10px; font-size: 18px;  line-height: 150%;}
		...
		.f_sub_con{ height: 350px;  border-radius: 4px;  padding: 10px 20px;}
		.f_sub_con h4{ border-left: solid 5px black; padding-left: 8px; padding-top: 3px;}
...
<body>
	...
	<div class="container">
		<header class="f_con_header">
			 <div>
				<i class="fas fa-chevron-left"></i><span>*지역명* 돌아가기</span>
			 </div>
			 <div class="f_con_title">
			 	<h2>축제 이름</h2>	<!-- 여행지 이름 -->
			 	<h5>축제 소재지</h5>	<!-- 여행지 소재지 -->
			 </div>
			 <div class="f_con_tab">
			 	<ul>
		...
		<section class="f_contents_main" style="margin-top: 50px; ">
...
<!------------------- 카카오 지도 api -------------------->
		...
		<section class="f_contents_sub">
		
			<div id="f_con_another">
				<div class="f_con_subtitle">
					<h3>연관정보</h3>
				</div>
				<div class="f_sub_con" style="background-color: #F8F8F8;">
					<h4>인근 축제</h4>
